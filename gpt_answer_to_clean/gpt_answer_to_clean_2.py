...
## 대용량 json 파일 불러와 로드
with open("output/experiment2_few_shot/3-shot/output.json", "r", encoding="UTF-8") as f:
...
with open("output/experiment2_few_shot/3-shot/output_clean.json", "w", encoding="UTF-8") as out_file:
